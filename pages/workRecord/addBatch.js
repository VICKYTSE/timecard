 ...
 */
  ...
  addBatch:function(e){
    ...
    record.userIds = that.data.inputIds
    ...
    wx.request({
      url: app.globalData.url+'/workRecord/addBatch',
      data: {
  ...
  userIdInput:function(e){
    var userIdStr = e.detail.value
    var userId0 = userIdStr.split(',')
    var userId = userIdStr.split('，')
    var that = this
    that.setData({
      inputIds:userId
    })
